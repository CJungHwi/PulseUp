 ...
 *
 * 관련 컴포넌트: `WorkoutControl`, `REMOTE_CONTROL_POPUP`/`getRemoteControlPopupWindowFeatures`.
 *
 ...
 */
const copyTokenFromOpener = (): void => {
  ...
  try {
    ...
    if (opener && opener.sessionStorage) {
      const openerToken = opener.sessionStorage.getItem('token') || opener.sessionStorage.getItem('accessToken')
      if (openerToken) {
