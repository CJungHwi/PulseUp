/**
 * DynamicStretchingMasterPanel — 좌측 패널: 검색 + 마스터 목록 + 상세 목록 (수직 스플리터 포함)
 *
 * 표시:
...
import type { WorkoutDetail, WorkoutMaster } from './dynamicStretchingTypes'
...
interface DynamicStretchingMasterPanelProps {
  leftWidth: number
  topHeight: number
...
export const DynamicStretchingMasterPanel: React.FC<DynamicStretchingMasterPanelProps> = ({
  leftWidth,
  topHeight,
  selectedDate,
  memoFilter,
